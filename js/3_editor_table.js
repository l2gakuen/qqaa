!(function (t, e) {
  ...
  return (function (t) {
    ...
    function (t, e) {
      t.exports =
        '<svg xmlns="http://www.w3.org/2000/svg" width="18" height="18"><rect width="18" height="18" fill="#F4F5F7" rx="2"></rect><circle cx="11.5" cy="6.5" r="1.5"></circle><circle cx="11.5" cy="11.5" r="1.5"></circle><circle cx="6.5" cy="6.5" r="1.5"></circle><circle cx="6.5" cy="11.5" r="1.5"></circle></svg>';
    },
    function (t, e, o) {
      var r = o(2);
    ...
    function (t, e, o) {
      ...
      function u(t, e) {
        for (var o = 0; o < t.length; o++) {
          ...
          if (i) {
            ...
            var l = [];
            for (s = 0; s < r.parts.length; s++) l.push(v(r.parts[s], e));
            n[r.id] = { id: r.id, refs: 1, parts: l };
          }
        }
      }
      function f(t, e) {
        for (var o = [], r = {}, i = 0; i < t.length; i++) {
          ...
          r[s] ? r[s].parts.push(l) : o.push((r[s] = { id: s, parts: [l] }));
        }
        return o;
      }
      function g(t, e) {
        ...
        if ("top" === t.insertAt)
          r
            ? r.nextSibling
              ? o.insertBefore(e, r.nextSibling)
              : o.appendChild(e)
      ...
      function R(t, e, o) {
        ...
        (e.convertToAbsoluteUrls || n) && (r = p(r)),
          i &&
            (r +=
        ...
        var s = new Blob([r], { type: "text/css" }),
          l = t.href;
        (t.href = URL.createObjectURL(s)), l && URL.revokeObjectURL(l);
      }
    },
    function (t, e) {
      t.exports = function (t) {
    ...
    function (t, e, o) {
      ...
      class a {
        ...
        render() {
          return (
            (this.wrapper = r("div", a.CSS.popover)),
            this.items.forEach((t, e) => {
              const o = r("div", a.CSS.item),
                i = r("div", a.CSS.itemIcon, { innerHTML: t.icon }),
                n = r("div", a.CSS.itemLabel, { textContent: t.label });
              (o.dataset.index = e),
                o.appendChild(i),
                o.appendChild(n),
        ...
        popoverClicked(t) {
          ...
          const o = e.dataset.index,
            r = this.items[o];
          !r.confirmationRequired || this.hasConfirmationState(e)
            ? r.onClick()
        ...
        open() {
          this.items.forEach((t, e) => {
            "function" == typeof t.hideIf &&
              this.itemEls[e].classList.toggle(a.CSS.itemHidden, t.hideIf());
          }),
            this.wrapper.classList.add(a.CSS.popoverOpened);
        }
        close() {
          this.wrapper.classList.remove(a.CSS.popoverOpened),
            this.itemEls.forEach((t) => {
      ...
      class h {
        ...
        createToolbox() {
          const t = r("div", [
              h.CSS.toolbox,
              this.cssModifier ? `${h.CSS.toolbox}--${this.cssModifier}` : "",
            ]),
        ...
        createToggler() {
          const t = r("div", h.CSS.toggler, { innerHTML: d.a });
          return (
        ...
        createPopover() {
          return (
            (this.popover = new a({ items: this.items })), this.popover.render()
          );
        }
        togglerClicked() {
          this.popover.opened
        ...
        hide() {
          this.popover.close(),
            this.wrapper.classList.remove(h.CSS.toolboxShowed);
        }
      }
      const p =
      ...
      class R {
        constructor(t, e, o, r) {
          (this.readOnly = t),
            ...
            (this.documentClicked = (t) => {
              const e = null !== t.target.closest("." + m),
                o = null === t.target.closest("." + f);
              (e || o) && this.hideToolboxes();
              const r = t.target.closest("." + y),
                i = t.target.closest("." + k);
              r && r.parentNode === this.wrapper
        ...
        bindEvents() {
          document.addEventListener("click", this.documentClicked),
            ...
            (this.table.onkeypress = (t) => this.onKeyPressListener(t)),
            this.table.addEventListener("keydown", (t) =>
              this.onKeyDownListener(t)
            ),
            this.table.addEventListener("focusin", (t) =>
              this.focusInTableListener(t)
            );
        }
        createColumnToolbox() {
          return new h({
        ...
        getCell(t, e) {
          return this.table.querySelector(
            `.${w}:nth-child(${t}) .${x}:nth-child(${e})`
          );
        }
        getRow(t) {
          return this.table.querySelector(`.${w}:nth-child(${t})`);
        }
        getRowByCell(t) {
          return t.parentElement;
        }
        getRowFirstCell(t) {
          return t.querySelector(`.${x}:first-child`);
        }
        ...
        addColumn(t = -1, e = !1) {
          ...
          for (let r = 1; r <= this.numberOfRows; r++) {
            ...
            if (
              (t > 0 && t <= o
                ? ((i = this.getCell(r, t)), s(n, i))
                : (i = this.getRow(r).appendChild(n)),
              1 === r)
            ) {
        ...
        addRow(t = -1, e = !1) {
          ...
          const a = this.getRowFirstCell(o);
          return a && e && l(a), o;
        }
        deleteColumn(t) {
        ...
        createTableWrapper() {
          if (
            ((this.wrapper = r("div", f)),
            (this.table = r("div", m)),
            this.readOnly && this.wrapper.classList.add(g),
            this.wrapper.appendChild(this.toolboxRow.element),
            this.wrapper.appendChild(this.toolboxColumn.element),
            this.wrapper.appendChild(this.table),
            !this.readOnly)
          ) {
            const t = r("div", k, { innerHTML: u }),
              e = r("div", y, { innerHTML: u });
        ...
        computeInitialSize() {
          const t = this.data && this.data.content,
            ...
            a = !isNaN(s) && s > 0 ? s : void 0;
          return { rows: r || l || 2, cols: i || a || 2 };
        }
        resize() {
        ...
        get numberOfColumns() {
          return this.numberOfRows
            ? this.table.querySelector(`.${w}:first-child`).childElementCount
            : 0;
        }
        ...
        focusInTableListener(t) {
          ...
          this.focusedCell = {
            row:
              Array.from(this.table.querySelectorAll("." + w)).indexOf(o) + 1,
            column: Array.from(o.querySelectorAll("." + x)).indexOf(e) + 1,
          };
        }
        hideToolboxes() {
          this.hideRowToolbox(),
              ...
              (t > 0 &&
                ...
                this.toolboxRow.show(() => {
                  const e = this.getRow(t),
                    { fromTopBorder: o } = n(this.table, e),
                    { height: r } = e.getBoundingClientRect();
                  return { top: Math.ceil(o + r / 2) + "px" };
                }));
        }
        setHeadingsSetting(t) {
          (this.tunes.withHeadings = t),
            t
              ? (this.table.classList.add(b), this.addHeadingAttrToFirstRow())
              : (this.table.classList.remove(b),
        ...
        selectRow(t) {
          const e = this.getRow(t);
          e && ((this.selectedRow = t), e.classList.add(v));
        }
        unselectRow() {
          if (this.selectedRow <= 0) return;
          const t = this.table.querySelector("." + v);
          t && t.classList.remove(v), (this.selectedRow = 0);
        }
        selectColumn(t) {
          for (let e = 1; e <= this.numberOfRows; e++) {
            const o = this.getCell(e, t);
        ...
        unselectColumn() {
          ...
          let t = this.table.querySelectorAll("." + C);
        ...
        getHoveredCell(t) {
          ...
          const {
            ...
            const o = t.getBoundingClientRect(),
              { width: r, height: i, x: n, y: s } = o,
              { clientX: l, clientY: a } = e;
            return { width: r, height: i, x: l - n, y: a - s };
          })(this.table, t);
          return (
            n >= 0 &&
              (o = this.binSearch(
                ...
                (t) => this.getCell(1, t),
                ({ fromLeftBorder: t }) => n < t,
                ({ fromRightBorder: t }) => n > r - t
              )),
            s >= 0 &&
              (e = this.binSearch(
                this.numberOfRows,
                (t) => this.getCell(t, 1),
                ({ fromTopBorder: t }) => s < t,
                ({ fromBottomBorder: t }) => s > i - t
              )),
            { row: e || this.hoveredRow, column: o || this.hoveredColumn }
          );
        }
        binSearch(t, e, o, r) {
          let i,
        ...
        getData() {
          const t = [];
          for (let e = 1; e <= this.numberOfRows; e++) {
            const o = this.table.querySelector(`.${w}:nth-child(${e})`),
              r = Array.from(o.querySelectorAll("." + x));
            r.every((t) => !t.textContent.trim()) ||
              t.push(r.map((t) => t.innerHTML));
          }
          return t;
        }
        destroy() {
      ...
      o(1),
        (e.default = class {
          ...
          constructor({ data: t, config: e, api: o, readOnly: r }) {
            (this.api = o),
              (this.readOnly = r),
              (this.config = e),
              (this.data = {
          ...
          render() {
            return (
              ...
              (this.container = r("div", this.api.styles.block)),
          ...
          save() {
            ...
            return { withHeadings: this.data.withHeadings, content: t };
          }
          destroy() {
            this.table.destroy();
          }
          ...
          onPaste(t) {
            const e = t.detail.data,
              ...
              r = Array.from(e.querySelectorAll("tr")).map((t) =>
                Array.from(t.querySelectorAll("th, td")).map((t) => t.innerHTML)
              );
            (this.data = { withHeadings: null !== o, content: r }),
              this.table.wrapper &&
