...
$__tmp = version_compare(phpversion(), "5") == -1 ? array(
    'FPDM'
) : array(
    'FPDM',
    false
    ...
    class FPDM
    {
        ...
        function Output($dest = '', $name = '')
        {
            ...
            if ($this->support == "pdftk") {
                ...
                $ret = pdftk($pdf_file, $fdf_file, array(
                    "security" => $security,
        ...
        function _set_field_value($line, $value)
        {
            ...
            if (preg_match($field_regexp, $CurLine)) {
                ...
                $CurLine = preg_replace_callback($field_regexp, create_function('$matches', $callback_code), $CurLine);
            } else {
                if ($verbose_set)
